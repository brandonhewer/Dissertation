...
\usetikzlibrary{arrows,decorations.pathmorphing,shapes,shadows}
...
\definecolor{blue(ncs)}{rgb}{0.0, 0.424, 0.592}
...
\lstdefinestyle{javascriptStyle}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, export, import},
  keywordstyle=\color{blue(ncs)}\bfseries,
  ndkeywords={class, boolean, throw, implements, extends, this, interface, readonly},
  ...
  comment=[l]{//},
  sensitive=true,
	morecomment=[l][\color{darkgray}\ttfamily\small]{--},
	morecomment=[s][\color{darkgray}\ttfamily\small]{\{-}{-\}},
	morestring=[b]",
	stringstyle=\color{red},
	showstringspaces=false,
	numberstyle=\small,
...
\lstdefinestyle{cppStyle}{
  keywords={using, typeof},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={class, struct},
  ndkeywordstyle=\color{purple}\bfseries,
  emph={
    int, size_t
  },
...
\lstset{basicstyle=\ttfamily,style=haskellStyle}
