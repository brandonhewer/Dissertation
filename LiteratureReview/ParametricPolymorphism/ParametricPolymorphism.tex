...
\par
Let $\Gamma$, $\Sigma$, $\Delta$ and $\Lambda$ be finite lists of formulae, known as contexts. The cut-rule is then defined as follows:
...
\end{prooftree}.
\end{equation}
The cut-rule depicted in (\ref{eq:cut}) can be described as cutting any occurrence of $X$ from the proof.
