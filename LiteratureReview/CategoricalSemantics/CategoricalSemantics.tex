...
\begin{document}
In the pursuit of a categorical semantics for parametricity, a well-known isomorphism will be introduced, termed the Curry-Howard-Lambek correspondence. A formal definition of the categorical semantics of the simply-typed lambda calculus will be given. Finally, 
